    ...
    <div class="container">
        ...
        <div class="row">
            <div class="cards " style="width: 22rem;">
                <img src="assets/images/trophy/1.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <center>
            ...
            <div class="cards " style="width: 22rem;">
                <img src="assets/images/trophy/2.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <center>
            ...
            <div class=" cards" style="width: 22rem;">
                <img src="assets/images/trophy/3.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <center>
