...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 24, 2023 at 07:57 AM
...
(1, 'NIMS SCHOOL OF HUMANITIES AND LIBERAL ART', 'NIMS SCHOOL OF BUSINESS', 'KABADDI / Male', 'pending', '2023-04-24T11:00', '2023-04-24 09:40:04'),
(2, 'NIMS SCHOOL OF LAW', 'NIMS SCHOOL OF BUSINESS', 'KABADDI / Male', 'pending', '2023-04-24T03:00', '2023-04-24 09:41:56'),
(3, 'NIMS NURSING COLLEGE ', 'NIMS COLLEGE OF PHYSIOTHERAPY ', 'KABADDI / Male', 'pending', '2023-04-24T05:00', '2023-04-24 09:43:55'),
(4, 'NIMS SCHOOL OF BUSINESS', 'NIMS NURSING COLLEGE ', 'KHO-KHO / Male', 'pending', '2023-04-24T11:00', '2023-04-24 09:45:36'),
(5, 'NIMS SCHOOL OF BUSINESS', 'NIMS INSTITUTE OF PHARMACY', 'KHO-KHO / Male', 'pending', '2023-04-24T05:00', '2023-04-24 09:47:56'),
(6, 'NIMS INSTITUTE OF PHARMACY', 'NIMS COLLEGE OF PARAMEDICAL & TECHNOLOGY', 'KHO-KHO / Female', 'pending', '2023-04-24T12:00', '2023-04-24 09:50:31'),
(7, 'NIMS COLLEGE OF PARAMEDICAL & TECHNOLOGY', 'NIMS INSTITUTE OF ENGINEERING & TECHNOLOGY ', 'FOOTBALL / Male', 'pending', '2023-04-24T11:30', '2023-04-24 09:51:43'),
(8, 'NIMS INSTITUE OF MEDICAL SCIENCES & RESEARCH ', 'NIMS COLLEGE OF PHYSIOTHERAPY ', 'FOOTBALL / Male', 'pending', '2023-04-24T04:30', '2023-04-24 09:52:43'),
(9, 'NIMS SCHOOL OF BUSINESS', 'NIMS DENTAL COLLEGE & HOSPITAL', 'FOOTBALL / Male', 'pending', '2023-04-24T05:30', '2023-04-24 09:53:45');
...
(8, 'AyushKaushik', 'ayushkaushik690@gmail.com', '9461508419', '$2y$10$GmeyW093FtBp7/Yt35wJB.5HFv974s8isa9nfGA2jxoM7A2kTLLSi', 'admin', './demo/profile_picture/FMtrAZPqQu/', '2023-04-24 02:19:35'),
(9, 'SAMIR ALAM', 'mrsamiralam21@gmail.com', '9031976507', '$2y$10$GHWVTnz6MrSmfeHndnHAMO9VYTAj1OpilJ1vvtVahwJa6SWPLr.pa', 'admin', './demo/profile_picture/D2M4vkt8N7/', '2023-04-24 02:20:30'),
(10, 'PankajKumar', 'pk9200523@gmail.com', '8852996157', '$2y$10$6IV2WIpUlCLNyUE5cI4p/OC1ocP0peutJyDdUes31TMk.EX9aPKGy', 'admin', './demo/profile_picture/7CGXis4jfZ/', '2023-04-24 02:21:10'),
(11, 'SauravKumar', 'xmartitsolution@gmail.com', '6299146487', '$2y$10$BRhn1yOknBdV1W5./nNDNO2FmE0LXTg5f6tY3M4isy6P/KyQif8OS', 'admin', './demo/profile_picture/ak1x56cvyM/', '2023-04-24 02:22:10'),
(12, 'RonakPaul', 'ronakpaul882@gmail.com', '8829032844', '$2y$10$yqj84VYmwc2TZZN7ZVQVKOUqY1G6ouGY/ZRJhtEtEdoNU30EkwEbi', 'admin', './demo/profile_picture/7f3Ym6sBPx/', '2023-04-24 02:22:53'),
(13, 'VikramKumarSharma', 'thevikramkumarsharma@gmail.com', '7761967453', '$2y$10$770uKB0PFlp89pXjaVKwLuxjPDQrPllbDjKdVr5UuAFYPUVmaY5pK', 'admin', './demo/profile_picture/FLryx4H32W/', '2023-04-24 02:24:13'),
(14, 'SiyaSrivastava', 'siyasrivastava62@gmail.com', '8810858784', '$2y$10$Od7goYu1fd7AZVcVpmQ2DubY.mTqiMf3gTdfYh9Rk8nV6sfOBMylq', 'admin', './demo/profile_picture/qkEaIS0HNA/', '2023-04-24 02:25:00'),
(15, 'DhanvanKumar', 'dhanvankumarspk@gmail.com', '8873835374', '$2y$10$koa6e9dFH8oc/se5slVj4eHUHLo.braE1Imxyn1RwnzqUk6Ztg4B.', 'admin', './demo/profile_picture/qaGQEnj3YX/', '2023-04-24 02:25:54');
